...
import { CheckOutlined, CheckSquareOutlined, CloseOutlined, SketchOutlined, UserOutlined } from "@ant-design/icons";
...
function KetQuaDatVe(props) {
  ...
  useEffect(() => {
    ...
    dispatch(action);
    console.log("ketquadat useEffect");
  }, []);

  //Khi người dùng nhấn nút close trên modal
  const addDatGheThanhCong = () => {
    //Set lai deps de call lai apis
    // setstateDsGheDatThanhCong(!stateDsGheDatThanhCong);
  };
  const renderTicket = () => {
        ...
        <div className="p-2 lg:w-1/3 md:w-1/2 w-full" key={index}>
          <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
            ...
            <div className="flex-grow">
              ...
              <p>
                Địa điểm: {seats.tenHeThongRap} - {seats.tenHeThongRap}
              </p>
              <p>
                {seats.tenCumRap} - Ghế:{" "}
